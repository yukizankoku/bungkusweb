...
const Menu = (props) => {
    return (
        <li>
            <Link
                to={props.href}
                className="block py-2 px-3 text-black rounded md:bg-transparent hover:bg-cyan-300 md:p-0"
                aria-current="page"
            >
                {props.children}
            </Link>
