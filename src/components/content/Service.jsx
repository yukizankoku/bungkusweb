...
function Service() {
  return (
    <div className="h-1/2 service text-center" data-aos="fade-up"
    data-aos-duration="3000">
      <section className="bg-putih rounded-3xl">
...
function ServiceItem({ imageSrc, title, description }) {
  return (
    <div className="relative bg-secondary rounded-md group text-center">
      {/* Gambar */}
      <img
        src={imageSrc}
        alt={title}
